...
(function( $, undefined ) {
  ...
  $.widget( "ui.addresspicker", {
    ...
    reloadPosition: function() {
		console.log(this.lat.val());
		console.log(this.lng.val());
      this.gmarker.setVisible(true);
      this.gmarker.setPosition(new google.maps.LatLng(parseFloat(this.lat.val()), parseFloat(this.lng.val())));
    ...
    _findInfo: function(result, type) {
      ...
      for (var i = 0; i < result.address_components.length; i++) {
        ...
        if (component.types.indexOf(tmp_type) !=-1) {
			if( type == 'country_code' ) {
